...
We will be using R for all data wrangling, visualization, and analysis. I will also be using JAMOVI to show how to mirror things in a different software. Students must have the latest version of R and it is strongly recommended that students also download the RStudio GUI, both can be found [here](https://posit.co/download/rstudio-desktop/#download). JAMOVI is also available [here](https://www.jamovi.org/index.html). All are free.
