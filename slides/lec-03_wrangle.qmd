...
subtitle: "Date: September 3, 2026"
...
- We will use the TIPI data (Note: We will also be using it in our [lab 3](../labs/lab-03_data-wrangling.html)
...
Review by looking at the [cheatsheet](https://rstudio.github.io/cheatsheets/data-transformation.pdf){target="_blank"} for `dplyr`.
...
We have the [Ten Item Personality Inventory](https://gosling.psy.utexas.edu/scales-weve-developed/ten-item-personality-measure-tipi/){target="_blank"}
...
The TIPI documention highlights certain variables that need this done

We can take the max value, add 1, then subtract the Item Score
