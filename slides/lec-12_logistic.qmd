...
[genzplyr 💅](https://hadley.github.io/genzplyr/){target="_blank"}
...
-   If we have a reason to have a reference group –\> **Regression**

    -   Maybe we have a control group

-   If we just expect a difference somewhere –\> **ANOVA**
...
::: callout-note
Dr. Haraden needs to write the equation on the board 🧑‍🏫 Calculate the expected value for each group
:::
...
### GLM - 6️⃣7️⃣ Data Interpretation
...
### GLM - 6️⃣7️⃣ Data Interpretation (tables)
...
Predicting the probability of believing in ghosts. Hopefully we have time to go through this example 👻
