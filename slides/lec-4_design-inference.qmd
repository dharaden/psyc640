...
-   For now, you only need to know one major distinction. This choice determines how much you can generalize.
...
We have collected our data...how do we know if these differences are "real" or that it is just due to random chance?
...
|:----------------------------------:|:----------------------------------:|
| Probability is a **long-run frequency** of an event | Probability of an event as the **degree of belief** |
