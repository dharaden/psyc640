---
title: "Week 2 Exercise - Intro to Tidy Data"
editor: visual
---

### **In-Class Activity: Your First (in-person) R Session**

**Goal**: To become more familiar with the RStudio interface and perform a basic data exploration workflow.

### Create a new Markdown Document

1.  Go to `File > New File > Quarto Document`

2.  Provide the title "Intro to Tidy Data" and input your name as the author

3.  A script will open in the **Source** pane. Remove unnecessary code.

4.  Go to `File > Save` and name it `wk2_tidy-data.qmd`. Make sure this saves in the same folder as all of your other stuff. Stay Organized!
...
In the text field of the markdown file answer these questions below:

> - Name
>
> - Comfort with R (1-10 with 10 being "Master")
>
> - Overall feelings toward Statistics and R
>
> - What could you give a 30 minute master class on with no preparation?
