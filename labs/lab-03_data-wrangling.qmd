...
Please complete the exercises below. Create a new `.qmd` file and
...
an HTML document. You will submit both this `.qmd` file and the
🧶knitted `.html` file.
...
::: callout-note
You can also just use the `janitor` functions that we went over in class
:::
