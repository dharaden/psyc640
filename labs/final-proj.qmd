...
**Objective:** The goal of the final project is to apply your knowledge
of data analysis skills that we have learned in this course. You will
begin by having a research question that you will attempt to answer with
an open dataset. Then you will highlight the process, and report the
appropriate analyses. All information should be self-contained and 100%
reproducible with the file/folder that you have uploaded.
